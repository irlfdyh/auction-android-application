...
import com.production.auctionapplication.repository.networking.CategoryJsonResponse
import com.production.auctionapplication.repository.networking.getCategoryName
...
class CreateUpdateStuffViewModel(application: Application) : AndroidViewModel(application) {
     ...
     */
    private var _stuffCategory = mutableListOf<Category>()

    /**
     * properties to setup key and value to get id from item that selected
     * from the drop down.
     */
    private val setKeyValue = mutableMapOf<String, Category>()
     ...
     */
    private fun setupCategoryName(responseData: CategoryJsonResponse){
